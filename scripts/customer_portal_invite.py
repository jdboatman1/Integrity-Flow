# ==============================================================
# Frappe Server Script — Auto-Send Customer Portal Invite
# DocType:   Customer
# Event:     after_insert
#
...
#   DocType: Customer
#   DocEvent: after_insert
# ==============================================================

import frappe
from frappe import _

def send_portal_invite(doc):
    ...
    try:
        ...
        # Log success
        frappe.logger().info(f"Portal invite sent to {doc.email_id} for customer {doc.name}")
